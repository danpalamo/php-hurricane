            ...
            if (!!that.opts.noshadow) {
              ...
              if (href.indexOf("/red.png")>-1 
               ...
               || href.indexOf("-dot.png")>-1 ) {
                  that.styles["#"+styleID].shadow="https://maps.google.com/mapfiles/ms/icons/msmarker.shadow.png";
              }
              else if (href.indexOf("-pushpin.png")>-1) {
                  that.styles["#"+styleID].shadow="https://maps.google.com/mapfiles/ms/icons/pushpin_shadow.png";
              }
              else {
